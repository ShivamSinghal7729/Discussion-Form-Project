...
public class Reply extends AbstractEntity {
	...
	public void autoGenerateId() {
		...
		//
		this.setId(lastEntry); // seting the id with the help of (set)
	...
	public String getMessage() {
		...
		return message; // returning the variable with return type String
	}
	...
	public void setMessage(String message) {
		...
		this.message = message; //   instanceting  variable with this keyword
	}
	...
	public User getUser() {
		...
		return user; //returning the user type in getUser method
	}
	...
	public void setUser(User user) {
		...
		this.user = user; // instanceting the variable user with keyword this
	}
